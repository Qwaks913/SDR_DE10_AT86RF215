...
module soc_system_mm_interconnect_3 (
		...
		input  wire [7:0]  msgdma_0_mm_write_byteenable,                                       //                                                             .byteenable
		input  wire        msgdma_0_mm_write_write,                                            //                                                             .write
		input  wire [63:0] msgdma_0_mm_write_writedata,                                        //                                                             .writedata
	...
	wire   [63:0] msgdma_0_mm_write_translator_avalon_universal_master_0_readdata;      // msgdma_0_mm_write_agent:av_readdata -> msgdma_0_mm_write_translator:uav_readdata
	...
	wire    [7:0] msgdma_0_mm_write_translator_avalon_universal_master_0_byteenable;    // msgdma_0_mm_write_translator:uav_byteenable -> msgdma_0_mm_write_agent:av_byteenable
	...
	wire   [63:0] msgdma_0_mm_write_translator_avalon_universal_master_0_writedata;     // msgdma_0_mm_write_translator:uav_writedata -> msgdma_0_mm_write_agent:av_writedata
	wire    [3:0] msgdma_0_mm_write_translator_avalon_universal_master_0_burstcount;    // msgdma_0_mm_write_translator:uav_burstcount -> msgdma_0_mm_write_agent:av_burstcount
	wire          rsp_mux_src_valid;                                                    // rsp_mux:src_valid -> msgdma_0_mm_write_agent:rp_valid
	wire  [145:0] rsp_mux_src_data;                                                     // rsp_mux:src_data -> msgdma_0_mm_write_agent:rp_data
	wire          rsp_mux_src_ready;                                                    // msgdma_0_mm_write_agent:rp_ready -> rsp_mux:src_ready
	wire    [0:0] rsp_mux_src_channel;                                                  // rsp_mux:src_channel -> msgdma_0_mm_write_agent:rp_channel
	wire          rsp_mux_src_startofpacket;                                            // rsp_mux:src_startofpacket -> msgdma_0_mm_write_agent:rp_startofpacket
	wire          rsp_mux_src_endofpacket;                                              // rsp_mux:src_endofpacket -> msgdma_0_mm_write_agent:rp_endofpacket
	...
	wire          msgdma_0_mm_write_agent_cp_valid;                                     // msgdma_0_mm_write_agent:cp_valid -> router:sink_valid
	wire  [145:0] msgdma_0_mm_write_agent_cp_data;                                      // msgdma_0_mm_write_agent:cp_data -> router:sink_data
	wire          msgdma_0_mm_write_agent_cp_ready;                                     // router:sink_ready -> msgdma_0_mm_write_agent:cp_ready
	wire          msgdma_0_mm_write_agent_cp_startofpacket;                             // msgdma_0_mm_write_agent:cp_startofpacket -> router:sink_startofpacket
	wire          msgdma_0_mm_write_agent_cp_endofpacket;                               // msgdma_0_mm_write_agent:cp_endofpacket -> router:sink_endofpacket
