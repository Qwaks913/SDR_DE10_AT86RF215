//altlvds_rx BUFFER_IMPLEMENTATION="RAM" CBX_SINGLE_OUTPUT_FILE="ON" clk_src_is_pll="off" COMMON_RX_TX_PLL="OFF" DATA_RATE=""800.0 Mbps"" DESERIALIZATION_FACTOR=2 ENABLE_DPA_CALIBRATION="ON" ENABLE_DPA_MODE="OFF" ENABLE_SOFT_CDR_MODE="OFF" IMPLEMENT_IN_LES="OFF" INCLOCK_BOOST=0 INCLOCK_PERIOD=5000 INCLOCK_PHASE_SHIFT=0 INPUT_DATA_RATE=800 INTENDED_DEVICE_FAMILY=""Cyclone V"" LPM_TYPE="altlvds_rx" LVDS_RX_REG_SETTING="ON" NUMBER_OF_CHANNELS=1 PORT_RX_DATA_ALIGN="PORT_UNUSED" REFCLK_FREQUENCY=""20.000000 MHz"" REGISTERED_OUTPUT="ON" SIM_DPA_OUTPUT_CLOCK_PHASE_SHIFT=0 USE_CORECLOCK_INPUT="OFF" USE_EXTERNAL_PLL="OFF" X_ON_BITSLIP="ON" rx_in rx_inclock rx_out
