...
# ACDS 24.1 1077 linux 2025.06.24.22:11:51
# ----------------------------------------
...
# ----------------------------------------
# If signalTAPPLL is one of several IP cores in your
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "signalTAPPLL"
}
...
if ![info exists QUARTUS_INSTALL_DIR] { 
  set QUARTUS_INSTALL_DIR "/home/augustin/intelFPGA_standard/24.1std/quartus/"
}
...
alias com {
  echo "\[exec\] com"
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/signalTAPPLL.vo"
}
